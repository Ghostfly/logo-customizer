...
const webcomponentsjs = join(nodeModules, '@webcomponents/custom-elements');
...
const polyfills = [
  {
    from: resolve(`${webcomponentsjs}/custom-elements.min.js`),
...
const subDirectory = ENV === 'production' ? 'bestlodger' : '';
...
const commonConfig = WebpackMerge([
  {
    ...
    output: {
      ...
      publicPath: ENV === 'production' ? '/bestlodger' : '/'
    },
    resolve: {
